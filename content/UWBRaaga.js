function question1Click(){
    ...
    if (container.querySelector('div')){
        ...
        newElement.setAttribute('class', "py-5 px-4 bg-[#fefae0] border-x-[3px] border-b-[3px] rounded-b-2xl border-black self-center w-full");
...
function question3Click(){
    ...
    if (container.querySelector('div')){
        ...
        let newElement = document.createElement('div');
        newElement.setAttribute('class', "py-5 px-4 bg-[#fefae0] border-x-2 border-b-2 rounded-b-2xl border-black self-center w-full");
        let newTextElement = document.createElement('p');
